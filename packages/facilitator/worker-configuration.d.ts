/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 85178a6c251e9fc0708266f9e631b4e4)
...
declare namespace Cloudflare {
	...
	interface Env {
		ZEROG_MAINNET_RPC_URL: string;
		ZEROG_TESTNET_RPC_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ZEROG_MAINNET_RPC_URL" | "ZEROG_TESTNET_RPC_URL" | "FACILITATOR_PRIVATE_KEY">> {}
}
