/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 2b12c07f5fd8ec47c0092489861fa740)
// Runtime types generated with workerd@1.20260415.1 2026-04-15 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ZEROG_MAINNET_PAY_TO: string;
		ZEROG_TESTNET_PAY_TO: string;
		BASE_MAINNET_PAY_TO: string;
		BASE_SEPOLIA_PAY_TO: string;
		ARBITRUM_MAINNET_PAY_TO: string;
		ARBITRUM_SEPOLIA_PAY_TO: string;
		ZEROG_MAINNET_PRIVATE_KEY: string;
		ZEROG_TESTNET_PRIVATE_KEY: string;
		BASE_MAINNET_PRIVATE_KEY: string;
		BASE_SEPOLIA_PRIVATE_KEY: string;
		ARBITRUM_MAINNET_PRIVATE_KEY: string;
		ARBITRUM_SEPOLIA_PRIVATE_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FACILITATOR_URL" | "ZEROG_MAINNET_PAY_TO" | "ZEROG_TESTNET_PAY_TO" | "BASE_MAINNET_PAY_TO" | "BASE_SEPOLIA_PAY_TO" | "ARBITRUM_MAINNET_PAY_TO" | "ARBITRUM_SEPOLIA_PAY_TO" | "ZEROG_MAINNET_PRIVATE_KEY" | "ZEROG_TESTNET_PRIVATE_KEY" | "BASE_MAINNET_PRIVATE_KEY" | "BASE_SEPOLIA_PRIVATE_KEY" | "ARBITRUM_MAINNET_PRIVATE_KEY" | "ARBITRUM_SEPOLIA_PRIVATE_KEY">> {}
}
